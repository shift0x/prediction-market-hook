...
import { IVaultErrors } from "../interfaces/vault/IVaultErrors.sol";
import { IVaultEvents } from "../interfaces/vault/IVaultEvents.sol";
import { ISwapFeePercentageBounds } from "../interfaces/vault/ISwapFeePercentageBounds.sol";
import { PoolData, Rounding } from "../interfaces/vault/VaultTypes.sol";
...
} from "../../balancer-labs/v3-solidity-utils/openzeppelin/ReentrancyGuardTransient.sol";
